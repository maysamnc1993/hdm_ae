...
?>
    <li class="list-none">
        <a href="<?php echo esc_url($link); ?>" class="CTA_Default inline-flex items-center gap-2 text-sm uppercase  rounded-full py-2 px-5 text-brand-primary hover:bg-brand-primary hover:text-white hover:border-brand-primary transition-all duration-300">
