<form role="search" method="get" class="search-form" action="<?php echo esc_url(home_url('/')); ?>">
    <input type="search" placeholder="جستجو کنید ..." value="<?php echo get_search_query(); ?>" name="s" class="pl-10 pr-4 py-2 border border-primary-blue rounded-xl w-full focus:outline-none focus:ring-2 focus:ring-blue-500" />
